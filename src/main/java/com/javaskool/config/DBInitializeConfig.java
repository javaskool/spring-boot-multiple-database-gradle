	...
	public void initialize(){
		try {
			...
			logger.info("========SQL insert query executing 1==========");
			    try{
			    	statement.executeUpdate("INSERT INTO js_user_first_db.user_details(email,firstName,lastName,`password`) VALUES ('javaskool@test.com','Abc','Test','password');");
			    ...
			    try{
			    	statement.executeUpdate("INSERT INTO js_booking_second_db.booking_details(bookingAmount,createdBy,dropAddress,pickupAddress)VALUES('999',1,'Chennai','Bangalore'),('998',1,'Bangalore','Chennai');");
